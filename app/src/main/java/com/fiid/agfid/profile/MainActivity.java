...
public class MainActivity extends AppCompatActivity {
    ...
    EditText editTextUsername, editTextEmail, editTextPassword, editTextSekolah, editTextKelas, editTextNama;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextKelas = (TextInputEditText) findViewById(R.id.editTextKelas);
        editTextSekolah = (TextInputEditText) findViewById(R.id.editTextSekolah);
    ...
    private void registerUser() {
        ...
        if (TextUtils.isEmpty(sekolah)) {
            editTextSekolah.setError("Please enter your school");
            editTextSekolah.requestFocus();
            return;
        }

        if (TextUtils.isEmpty(kelas)) {
            editTextKelas.setError("Please enter Class");
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        User user = new User(
                                ...
                                userJson.getString("email"),/**KELAS DAN SEKOLAH */
                                userJson.getString("kelas"),
                                userJson.getString("sekolah")
